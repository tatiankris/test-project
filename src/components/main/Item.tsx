...
function Item({text, name, ...props}: ItemPropsType) {

    return (
        <div className={s.itemBlock}>
            <div className={s.item}>
                <div className={s.num}>{text}</div>
                <div className={s.itemName}>
                    <div className={s.name}>{name}</div>
                    <svg className={s.svg} preserveAspectRatio="none" viewBox="0 0 132 54" fill="none" xmlns="http://www.w3.org/2000/svg">
